...
class MRA_GCN_multitasks(nn.Module):
    ...
    def __init__(self,L_tilde_edge, dim_in_edge, dim_out_edge, range_K,
                 device,
...
class Sub_MAGCN(nn.Module):
    def __init__(self,  adj_sub_edge, L_tilde_edge, dim_in_edge, dim_out_edge,
        ...
        self.MRAGCN = MRA_GCN_multitasks( L_tilde_edge, dim_in_edge,
                                         dim_out_edge,
    ...
    def forward(self,X_edge, X_sub_edge, accident=None):
        '''
