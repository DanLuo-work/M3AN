...
def read_and_generate_dataset(graph_signal_matrix_node_filename, graph_signal_matrix_edge_filename, accident_filename,
    ...
    all_feature_node = np.array(all_feature_node)
    all_feature_edge = np.array(all_feature_edge)
    all_accident = np.array(all_accident)
    all_target_node = np.array(all_target_node)
    all_target_edge = np.array(all_target_edge)
